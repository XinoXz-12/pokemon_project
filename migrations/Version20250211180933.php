 ...
 */
final class Version20250211180933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokedex (id INT AUTO_INCREMENT NOT NULL, trainer_id INT NOT NULL, level INT DEFAULT NULL, strength INT DEFAULT NULL, UNIQUE INDEX UNIQ_6336F6A7FB08EDF6 (trainer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type JSON NOT NULL, image VARCHAR(255) NOT NULL, level INT NOT NULL, strength INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
